                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <div className="mt-2 flex flex-col items-center">
                    <button className='flex items-center rounded-md bg-gray-100 w-full hover:bg-gray-200'>
                        ...
                        <div className='font-medium flex justify-center w-full'><p>Signup with Google</p></div>
                    </button>
                  </div>
                  <div className='my-4'>
                    <form className='flex flex-col gap-3'>
                        ...
                        <div className='flex flex-col gap-2'>
                            <label className='text-lg font-medium' htmlFor='fullname'>Fullname</label>
                            <input className='border border-gray-300 rounded-md py-2 px-3 focus:outline-zomato-btnpink/75 focus:ring-zomato-btnpink' type='text' id='fullname' name='fullname' placeholder='John Doe'/>
                        </div>
