...
import NightLifeCollection from "../DataSet/NightLifeCollection";
            ...
            <div className="md:">
                ...
                <div className="md:p-4 lg:container lg:mx-auto lg:px-48">
                    <div className="flex flex-col gap-3 my-3 ">
                        <div className="px-3">
                            <h1 className="text-xl font-medium text-gray-800  md:text-3xl">Trending NightLife Restaurants in Mylapore</h1>
                        </div>
